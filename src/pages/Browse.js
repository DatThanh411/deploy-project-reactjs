              ...
              <div className="featured-games header-text">
                ...
                <div className="owl-features owl-carousel">
                  <div className="item">
                    ...
                    <ul>
                      <li><span className="fa fa-star"></span> 4.8</li>
                      <li><span className="fa fa-download"></span> 2.3M</li>
                    </ul>
                  </div>
                  <div className="item">
                    <div className="thumb">
              ...
              <div className="top-downloaded">
                ...
                <ul>
                  <li>
                    ...
                    <h4>Fortnite</h4>
                    <h6>Sandbox</h6>
                    <span><span className="fa fa-star" style={{color: "yellow"}}></span> 4.9</span>
                    <span><span className="fa fa-download" style={{color: "#ec6090"}}></span> 2.2M</span>
                    <div className="download">
                      <Link to="#"><span className="fa fa-download"></span></Link>
                    </div>
                  </li>
                  <li>
              ...
              <div className="col-lg-3 col-sm-6">
                <div className="item">
                  <div className="thumb">
                    ...
                    <div className="hover-effect">
                      <div className="content">
                        ...
                        <ul>
                          <li><Link to="#"><span className="fa fa-eye"></span> 1.2K</Link></li>
                          <li><Link to="#"><span className="fa fa-gamepad"></span> CS-GO</Link></li>
                        </ul>
                      </div>
                    </div>
                  </div>
                  <div className="down-content">
                    ...
                    <span><span className="fa fa-check"></span> KenganC</span>
              ...
              <div className="col-lg-3 col-sm-6">
                <div className="item">
                  ...
                  <div className="down-content">
                    ...
                    <span><span className="fa fa-check"></span> LunaMa</span>
              ...
              <div className="col-lg-3 col-sm-6">
                <div className="item">
                  ...
                  <div className="down-content">
                    ...
                    <span><span className="fa fa-check"></span> Areluwa</span>
              ...
              <div className="col-lg-3 col-sm-6">
                <div className="item">
                  ...
                  <div className="down-content">
                    ...
                    <span><span className="fa fa-check"></span> GangTm</span>
